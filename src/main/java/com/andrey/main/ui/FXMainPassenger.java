...
public class FXMainPassenger extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        URL resource = getClass().getResource("/fxml/passengers.fxml");
...
//        System.out.println(resource);
        ...
        PassengerController mainController = fxmlLoader.getController();
...
//        primaryStage.setTitle(fxmlLoader.getResources().getString("address_book"));
        ...
        primaryStage.setTitle("Passengers list");
